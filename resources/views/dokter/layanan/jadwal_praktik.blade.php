                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn-primary-pill"
                                        onclick="openModal(1, 'Budi Santoso', 'Laki-laki / 32 Thn', 'Demam & Pusing', 'BS')">
                                        Periksa
                                    </button>
                                </div>
                            </td>
                        ...
                        <tr class="patient-row" id="row-2">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn-primary-pill"
                                        onclick="openModal(2, 'Siti Aminah', 'Perempuan / 45 Thn', 'Cek Tensi', 'SA')">
                                        Periksa
                                    </button>
                                </div>
                            </td>
                ...
                <div class="modal-flex">              
                    <div class="modal-sidebar theme-dark">
                        ...
                        <div class="visual-bottom">
                            <svg width="50" height="50" fill="none" stroke="rgba(255,255,255,0.2)"
                                viewBox="0 0 24 24">
