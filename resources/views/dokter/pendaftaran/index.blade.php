    ...
    <div class="split-container">
      ...
      <main class="split-right">
        <div class="form-wrapper">
          ...
          <form action="{{ route('dokter.register') }}" method="POST" enctype="multipart/form-data" class="premium-form">
            @csrf
            ...
            <div class="form-section">
              ...
              <div class="row-grid">
                <div class="input-group">
                  ...
                  <input type="text" id="str" name="str" placeholder="Nomor Tanda Registrasi" required>
                </div>
                <div class="input-group">
                  <label for="sip">Nomor SIP</label>
                  <input type="text" id="sip" name="sip" placeholder="Nomor Izin Praktik" required>
                </div>
              </div>
            ...
            <div class="form-footer">
              ...
              <p class="disclaimer">Dengan mendaftar, Anda menyetujui <a href="#">Syarat & Ketentuan</a> Mitra
                Dokter KlikDoc.</p>
            </div>
          </form>
        </div>
