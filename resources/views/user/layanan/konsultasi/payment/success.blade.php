...
@push('styles')
    {{-- Sesuaikan path CSS ke folder konsultasi --}}
    ...
    <div class="success-page">
        <div class="success-card">
            ...
            <div class="text-content">
                ...
                <p>Terima kasih, jadwal konsultasi Anda telah terkonfirmasi. Silakan bersiap pada waktu yang ditentukan.</p>
            </div>
            ...
            <div class="receipt-box">
                ...
                <div class="receipt-row">
                    ...
                    <span class="value">Konsultasi Dokter</span>
                </div>
                <div class="receipt-row">
                ...
                <div class="receipt-row">
                    ...
                    <span class="value">Midtrans / Bank Transfer</span>
                </div>
            ...
            <div class="action-buttons">
                <a href="#" class="btn-primary">Lihat Detail Jadwal</a>
