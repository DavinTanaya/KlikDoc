                    ...
                    <div class="booking-card">
                        ...
                        <div class="booking-form">
                            @php
                                ...
                                $defaultAddress =
                                    $defaultAddress ??
                                    ($addresses->firstWhere('is_active', true) ?? $addresses->first());
                            @endphp
                                ...
                                @if ($noAddress)
                                    <div class="address-card empty-address">
                                        ...
                                        <button class="btn-add-address" data-bs-toggle="modal"
                                            data-bs-target="#addAddressModal" data-return-url="{{ url()->current() }}">
                                            Tambah Alamat Baru
                                        </button>
                                    </div>
                                @else
                                    <div class="address-card">
                                        ...
                                        <div class="address-details">
                                            ...
                                            <h3>{{ $defaultAddress->recipient_name }}
                                                ({{ $defaultAddress->phone_number }})</h3>
                                            <p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="scheduled_date" id="visitDate" class="form-control"
                        ...
                        @else
                            <form id="klikhomePayForm" action="{{ route('klikhome.pay', $service->slug) }}"
                                method="POST">
                                @csrf
