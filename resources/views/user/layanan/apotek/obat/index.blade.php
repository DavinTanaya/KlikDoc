                    ...
                    <div class="history-list">
                        ...
                        @forelse ($recentOrders as $order)
                            ...
                            <a href="{{ route('orders.detail', $order->order_code) }}"
                                style="text-decoration: none;color:inherit;" class="history-item">
                ...
                <div class="product-grid">
                    ...
                    @foreach ($drugs as $drug)
                        <div class="product-card" data-bs-toggle="modal" data-id="{{ $drug->id }}"
                            ...
                            data-unit="{{ $drug->short_description }}"
                            data-price="{{ number_format($drug->price, 0, ',', '.') }}"
                            data-category="{{ $drug->category }}"
                            data-description="{{ $drug->description ?? 'Tidak ada deskripsi.' }}"
                            data-dosage="{{ $drug->dosis ?? 'Tidak ada informasi dosis.' }}"
                            data-type="{{ $drug->type ?? '-' }}"
