              ...
              @foreach ($cartItems as $item)
                <div class="product-item">
                  ...
                  <div class="prod-info">
                    ...
                    <p>{{ $item->quantity }} x Rp {{ number_format($item->drug->price, 0, ',', '.') }}</p>
                  </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form action="{{ route('address.store') }}" method="POST">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
            <button type="submit" class="btn btn-primary" style="background-color: #1C274C; border: none;">Simpan
              Alamat</button>
          </div>
...
@push('scripts')
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      // ================================================
      // EDIT MODAL (hanya dijalankan jika default address ada)
      // ================================================
      ...
      if (editProv && editCity && defaultProvince !== "") {
        ...
        // Populate pertama saat halaman load
        populateCities(defaultProvince, editCity, defaultCity);

        // Listener jika provinsi diubah
