                            ...
                            <td class="text-end">
                                ...
                                @if (auth()->user()->role === 'admin')
                                    @if ($article->status === 'draft')
                                        <form action="{{ route('article.approve', $article) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                    ...
                                    @else
                                        <form action="{{ route('article.unpublish', $article) }}" method="POST"
                                            class="d-inline" onsubmit="return confirm('Unpublish artikel ini?')">
                                            @csrf
