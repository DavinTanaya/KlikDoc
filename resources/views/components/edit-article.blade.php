    ...
    <form method="POST" action="{{ route('article.update', $article) }}" enctype="multipart/form-data">
      ...
      <div class="card">
        ...
        <div class="form-group">
          <label>Judul</label>
          <input type="text" name="title" id="title" class="input" onkeyup="generateSlug(this.value)" value='{{ $article->title }}' required>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="category" class="input" placeholder="Penyakit Dalam" value="{{ $article->category }}">
        </div>
