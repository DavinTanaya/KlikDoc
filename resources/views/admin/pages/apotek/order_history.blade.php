    ...
    <main class="history-content">
      <div class="history-container">
        ...
        <div class="status-tabs">
          <a href="{{ route('admin.orders.history') }}" class="tab {{ request()->query('status') ? '' : 'active' }}"
            style="text-decoration: none">Semua</a>
          <a href="{{ route('admin.orders.history', ['status' => 'BELUM_BAYAR']) }}"
            class="tab {{ request()->query('status') === 'BELUM_BAYAR' ? 'active' : '' }}"
            style="text-decoration: none">Belum Bayar</a>
          <a href="{{ route('admin.orders.history', ['status' => 'DIPROSES']) }}"
            class="tab {{ request()->query('status') === 'DIPROSES' ? 'active' : '' }}"
            style="text-decoration: none">Diproses</a>
          <a href="{{ route('admin.orders.history', ['status' => 'SELESAI']) }}"
            ...
            <div class="order-card">
              ...
              <div class="card-header">
                <div class="meta">
                  ...
                  <span class="date" style="color:red">{{ $order->user->name ?? 'Pengguna' }}</span>
                </div>
              ...
              <div class="card-footer footer-action">
                ...
                @else
                  <a href="{{ route('admin.orders.detail', $order->order_code) }}" class="btn-outline">
                    Detail Pesanan
                  </a>
                @endif
