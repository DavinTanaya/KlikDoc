      ...
      <div class="history-container">
        ...
        <div class="status-tabs">
          ...
          <a href="{{ route('admin.applicants.history', ['status' => 'pending']) }}"
            class="tab {{ request('status') === 'pending' ? 'active' : '' }}" style="text-decoration: none">Pending</a>

          <a href="{{ route('admin.applicants.history', ['status' => 'approved']) }}"
            class="tab {{ request('status') === 'approved' ? 'active' : '' }}" style="text-decoration: none">Approved</a>

          <a href="{{ route('admin.applicants.history', ['status' => 'rejected']) }}"
            class="tab {{ request('status') === 'rejected' ? 'active' : '' }}" style="text-decoration: none">Rejected</a>

          <a href="{{ route('admin.applicants.history', ['status' => 'disabled']) }}"
            class="tab {{ request('status') === 'disabled' ? 'active' : '' }}" style="text-decoration: none">Disabled</a>
        </div>
