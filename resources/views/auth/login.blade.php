...
<body class="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-100 to-blue-200 p-4">
    ...
    <div class="animate-fade-in w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div class="mb-6 flex rounded-lg bg-gray-100 p-1">
            <button id="login-tab"
                class="tab-active w-1/2 rounded-md px-4 py-2 text-sm font-semibold transition-all duration-300 bg-white shadow-sm text-blue-600">Masuk</button>
        ...
        <div id="login-form">
            ...
            @if (session('error'))
                <div class="mb-4 rounded-lg bg-red-100 p-4 text-red-700 text-sm">
                    {{ session('error') }}
                </div>
            @endif
            <form action="{{ route('login.post') }}" method="POST" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <button type="button" id="toggle-login-password"
                        ...
                        <svg id="eye-off-icon-login" xmlns="http://www.w3.org/2000/svg"
                            class="hidden h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
            ...
            <form id="js-signup-form" data-action="{{ route('register.post') }}" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <button type="button" id="toggle-signup-password"
                        ...
                        <svg id="eye-off-icon-signup" xmlns="http://www.w3.org/2000/svg"
                            class="hidden h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
                                d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.27 8.138 16.544 6.834 14.601 6.045L13.186 4.63A12.012 12.012 0 0010 3C7.523 3 3.732 4.943.458 10a12.038 12.038 0 003.249 2.293L3.707 2.293zM10 12a2 2 0 100-4 2 2 0 000 4z"
                                clip-rule="evenodd" />
                ...
                <button type="submit" id="btn-submit-signup"
                    class="w-full transform rounded-lg bg-blue-500 px-4 py-2 font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-blue-300 disabled:scale-100">
                    Daftar
                </button>
            </form>
        </div>
    ...
    <script>
        ...
        function setupPasswordToggle(inputId, eyeIconId, eyeOffIconId, toggleBtnId) {
        ...
        setupPasswordToggle('login-password', 'eye-icon-login', 'eye-off-icon-login', 'toggle-login-password');
        setupPasswordToggle('signup-password', 'eye-icon-signup', 'eye-off-icon-signup', 'toggle-signup-password');
                ...
                try {
                    const response = await fetch(url, {
                        ...
                        headers: {
                            ...
                            // CSRF token biasanya sudah tercover oleh input hidden @csrf dalam formData,
                            // tapi jika butuh header eksplisit:
