        ...
        <div class="app-container" id="appContainer">
            ...
            <main class="chat-area">
                ...
                <div id="chatStatusBar"
                    class="chat-status-bar {{ $isActiveConsultation ? 'status-active' : 'status-closed' }}">
                    <span id="statusIcon">
                                ...
                                <div class="chat-card referral">
                                    ...
                                    <div class="referral-actions">
                                        <a class="btn-secondary"
                                            href="{{ route('referral.download', $message->referral_id) }}">
                ...
                <div id="callContainer" class="call-container">
                    <div class="video-wrapper" id="videoWrapper">
                        ...
                        <video id="remoteVideoUser" class="video-remote" autoplay playsinline
